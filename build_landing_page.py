...
# ---------------------------------------------------------------------------
Q1A_NARRATIVE = """
                <p>The steepest percentage declines were in <span style="color:red">Manufacturing (&minus;5.82%, &minus;3,100 jobs)</span> and <span style="color:red">Mining/Construction (&minus;4.82%, &minus;6,600 jobs)</span>. But the largest absolute loss came from a different source: <span style="color:red">Education &amp; Health shed 21,400 jobs</span> in a single year, the biggest decline of any sector by a wide margin. That is more than double the next-largest absolute loss.</p>

                <p>The seven contracting sectors are not a random assortment. <span style="color:red">Education &amp; Health (&minus;1.62%)</span> and <span style="color:red">Leisure &amp; Hospitality (&minus;2.28%)</span> are the two largest private-sector employers in the city, and together they account for 31,400 of the 39,400 total jobs lost. <span style="color:red">Trade/Transportation (&minus;1.22%)</span>, <span style="color:red">Professional &amp; Business Services (&minus;0.82%)</span>, and <span style="color:red">Other Services (&minus;2.77%)</span> show smaller but broad-based declines across consumer-facing and corporate services. Manufacturing and Mining/Construction lost the most in percentage terms but together represent fewer than 200,000 of the city&rsquo;s 4.8 million jobs.</p>

                <p>Only three sectors grew. <span style="color:green">Information (+1.93%)</span> led all supersectors. <span style="color:green">Government (+1.58%, +9,500 jobs)</span> added the most absolute positions. <span style="color:green">Financial Activities (+1.27%)</span> rounded out the group. The three growers are the parts of the economy least tied to consumer discretionary spending.</p>
