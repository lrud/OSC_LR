...
# ---------------------------------------------------------------------------
Q1A_NARRATIVE = """
                <p>The steepest percentage declines were in <span style="color:red">Manufacturing (&minus;5.82%, &minus;3,100 jobs)</span> and <span style="color:red">Mining/Construction (&minus;4.82%, &minus;6,600 jobs)</span>. But the largest absolute loss came from a different source: <span style="color:red">Education &amp; Health shed 21,400 jobs</span> in a single year, the biggest decline of any sector by a wide margin. That is more than double the next-largest absolute loss. <span style="color:red">Leisure &amp; Hospitality (&minus;2.28%)</span> lost another 10,000 jobs.</p>

                <p>These sectors moved the most for different reasons. Education &amp; Health and Leisure &amp; Hospitality are the two largest private-sector employers in the city, together accounting for 1.7 million of the 4.8 million total nonfarm jobs. When sectors that large contract, even small percentage moves produce large absolute losses &mdash; and together they account for 31,400 of the 39,400 total jobs lost citywide. Manufacturing and Mining/Construction show the opposite dynamic: they are the two smallest sectors in NYC, employing roughly 180,000 people combined, so relatively modest absolute losses produce the steepest percentage declines on the board.</p>

                <p>The middle tier of decliners &mdash; <span style="color:red">Trade/Transportation (&minus;1.22%)</span>, <span style="color:red">Professional &amp; Business Services (&minus;0.82%)</span>, and <span style="color:red">Other Services (&minus;2.77%)</span> &mdash; are broad-based sectors where consumer-facing and corporate-facing businesses sit side by side. The declines are smaller in magnitude but spread across retail, temp staffing, personal services, and warehousing, which points to a general pullback rather than a sector-specific shock.</p>

                <p>Only three sectors grew, and they share a common trait: demand for their output is less sensitive to consumer spending cycles. <span style="color:green">Information (+1.93%)</span> led all supersectors. <span style="color:green">Government (+1.58%, +9,500 jobs)</span> added the most absolute positions. <span style="color:green">Financial Activities (+1.27%)</span> rounded out the group.</p>
